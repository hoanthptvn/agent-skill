...
| `/review`| Đánh giá Semantic HTML + BEM (Tải `html-structure/SKILL.md` + `css-naming-conventions/SKILL.md`) |
| `/ship`  | Triển khai (Tải `../git-commit.md` để áp dụng Conventional Commits)           |
