...
# 🧮 Kỹ năng Thuật toán Front-End (Router)

> **Dành cho AI Agent:** Đây là tệp điều hướng. Không có thuật toán cụ thể ở đây. Hãy xác định nhu cầu của người dùng và đọc tệp tương ứng.
...
- `skills/algorithms/essential/sliding-window.md`: Tính toán FPS, tốc độ cuộn (Scroll Velocity).
- `skills/algorithms/essential/two-pointers.md`: Chạm đa điểm (Pinch-to-zoom), thu gọn mảng in-place.
- `skills/algorithms/essential/frequency-counter.md`: Phân nhóm (Category Filter), đếm tần suất realtime.
- `skills/algorithms/essential/spatial-hash.md`: Tối ưu check hover chuột trên hàng chục ngàn phần tử.
- `skills/algorithms/essential/graph-bfs-dfs.md`: Hiệu ứng lan tỏa sóng (Ripple Effect) từ điểm click.
