...
> áp dụng trong skill-css FLOCSS architecture.
...
8. [So sánh skill-css vs Nuxt UI](#8-so-sánh-skill-css-vs-nuxt-ui)
...
### Mapping skill-css ↔ Nuxt UI

| Tầng | Nuxt UI | skill-css | Ví dụ |
|------|---------|-----------|-------|
...
/* skill-css: dùng clamp() cho fluid scaling */
...
/* skill-css: tương tự nhưng base = 0.5rem (8pt grid) */
--space-unit: .5rem;
...
## 8. Lợi thế skill-css vs framework thông thường
...
### Những gì skill-css CÓ mà Nuxt UI KHÔNG có
...
### Những gì Nuxt UI CÓ mà skill-css ĐÃ HỌC
