...
Quy tắc bắt buộc khi AI viết code từ bộ skill-js này. Mục tiêu: con người đọc 1 lần hiểu ngay, không cần "giải mã".
...
## Áp dụng vào bộ skill-js

Khi AI đọc code example trong `algorithms/` và `types/`, lưu ý:

```
1. Code ví dụ trong skill-js viết NGẮN vì mục đích TÀI LIỆU (dạy thuật toán)
...
Ngoại lệ trong tài liệu skill-js:
