...
## 2. Quy Trình 5 Bước Bắt Buộc Dành Cho AI

Bạn bị CẤM nhảy vào viết code HTML/CSS ngay lập tức. BẮT BUỘC tuân thủ 5 bước sau (ghi suy nghĩ ra Markdown):
1. **Phân tích & Trích xuất:** Lập bảng Design Tokens (Màu, Font, Spacing).
2. **Xây móng HTML:** Viết bộ khung Semantic HTML tĩnh trước.
3. **Đổ nền CSS:** Chèn các biến CSS (`--clr-*`) vào `base.css`.
4. **Tạo hình Component:** Viết CSS cho Component tuân thủ Concentric CSS.
5. **Kiểm thử chéo:** Tự đối chiếu Visual QA 6 trục.

## 3. Kỹ thuật "Phơi bày Lũy tiến" (Progressive Disclosure)
